|                                                                | Erlang | Clojure | Haskell | Scala         | Java 6       | CPython 3 | F#/OCaml |
|----------------------------------------------------------------+--------+---------+---------+---------------+--------------+-----------+----------|
| TYPE DISCIPLINE                                                |        |         |         |               |              |           |          |
|----------------------------------------------------------------+--------+---------+---------+---------------+--------------+-----------+----------|
...
| common implementations have tail recursion optimization        | yes    | no      |         | no            |              | no        |          |
|                                                                |        |         |         |               |              |           |          |
| LIBRARY                                                        |        |         |         |               |              |           |          |
|----------------------------------------------------------------+--------+---------+---------+---------------+--------------+-----------+----------|
...
| single assignment                                              | yes    | no      | yes     | no            | no           | no        |          |
...
[fn:jc] Anonymouse classes can only access final external bindings.
