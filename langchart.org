| TYPE DISCIPLINE    | Clojure | Erlang | F#  | Haskell | Java | JavaScript | Perl | Python | Ruby | Scala |
|--------------------+---------+--------+-----+---------+------+------------+------+--------+------+-------|
| strongly typed     | yes     | yes    | yes | yes     | yes  |            | no   | yes    |      | yes   |
| statically typed   | no      | no     | yes | yes     | yes  | no         | no   | no     |      | yes   |
| coercion           |         |        | no  | no      | yes  |            | yes  | yes    |      | yes   |
...
| OBJECTS                    | Clojure | Erlang | F#  | Haskell | Java | JavaScript | Perl | Python | Ruby | Scala |
|----------------------------+---------+--------+-----+---------+------+------------+------+--------+------+-------|
| objects                    |         |        | yes |         | yes  | yes        |      | yes    |      | yes   |
| all values are objects     |         |        |     |         | no   |            |      | yes    |      | yes   |
| all operations are methods |         |        |     |         | no   | no         |      | no     | yes  | yes   |
...
| FUNCTIONS                         | Clojure | Erlang | F# | Haskell | Java | JavaScript | Perl | Python | Ruby | Scala |
|-----------------------------------+---------+--------+----+---------+------+------------+------+--------+------+-------|
...
| BINDINGS & SCOPE               | Clojure | Erlang | F#  | Haskell | Java | JavaScript | Perl | Python | Ruby | Scala |
|--------------------------------+---------+--------+-----+---------+------+------------+------+--------+------+-------|
| lexical scope                  |         |        | yes |         | yes  |            |      | no     |      | yes   |
| shadowing                      |         |        | yes |         | no   |            |      |        |      | yes   |
| shadowing in-block             |         |        | yes |         |      |            |      |        |      |       |
| single assignment variables    | no      | yes    | yes | yes     | yes  |            |      | no     |      | yes   |
| multiple assignment variables  | yes     | no     |     | no      | yes  |            |      | yes    |      | yes   |
| closures                       |         |        |     |         | no   |            |      |        |      | yes   |
| pattern matching               | yes     | yes    | yes | yes     | no   |            |      | no     |      | yes   |
...
| CONTROL                                         | Clojure | Erlang | F# | Haskell | Java | JavaScript | Perl | Python | Ruby | Scala |
|-------------------------------------------------+---------+--------+----+---------+------+------------+------+--------+------+-------|
...
| LIBRARY                 | Clojure | Erlang | F# | Haskell | Java | JavaScript | Perl | Python | Ruby | Scala |
|-------------------------+---------+--------+----+---------+------+------------+------+--------+------+-------|
...
| EVALUATION                    | Clojure | Erlang | F# | Haskell | Java | JavaScript | Perl | Python | Ruby | Scala |
|-------------------------------+---------+--------+----+---------+------+------------+------+--------+------+-------|
| ?lazy functions?              |         |        |    |         |      |            |      |        |      |       |
| ?lazy expressions?            |         |        |    |         |      |            |      |        |      |       |
...
| COLLECTIONS SYNTAX | Clojure | Erlang | F#  | Haskell | Java | JavaScript | Perl | Python | Ruby | Scala |
|--------------------+---------+--------+-----+---------+------+------------+------+--------+------+-------|
...
| SPECIAL SYNTAX      | Clojure | Erlang | F# | Haskell | Java | JavaScript | Perl | Python | Ruby | Scala |
|---------------------+---------+--------+----+---------+------+------------+------+--------+------+-------|
| regular expressions | no      | no     | no | no      | no   | no         | yes  | no     | yes  | no    |
| system calls        | no      | no     | no | no      | no   | no         | yes  | no     | yes  | no    |


| BASIC TYPES                 | Clojure | Erlang | F# | Haskell | Java | JavaScript | Perl | Python | Ruby | Scala |
|-----------------------------+---------+--------+----+---------+------+------------+------+--------+------+-------|
...
| IMPLEMENTATION              | Clojure | Erlang | F#  | Haskell | Java | JavaScript | Perl | Python | Ruby | Scala |
|-----------------------------+---------+--------+-----+---------+------+------------+------+--------+------+-------|
