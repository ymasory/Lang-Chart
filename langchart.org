| TYPE DISCIPLINE    | bash | Clojure | Erlang | F#  | Haskell | Java | JavaScript | Perl | Python | Ruby | Scala |
|--------------------+------+---------+--------+-----+---------+------+------------+------+--------+------+-------|
| typed              | no   | yes     | yes    | yes | yes     | yes  | yes        | yes  | yes    | yes  | yes   |
| strongly typed     | no   | yes     | yes    | yes | yes     | yes  |            | no   | yes    |      | yes   |
| statically typed   | no   | no      | no     | yes | yes     | yes  | no         | no   | no     |      | yes   |
| coercion           | no   |         |        | no  | no      | yes  |            | yes  | yes    |      | yes   |
| null reference     | no   |         |        |     | no      | yes  |            |      | yes    |      | yes   |
...
| OBJECTS                    | bash | Clojure | Erlang | F#  | Haskell | Java | JavaScript | Perl | Python | Ruby | Scala |
|----------------------------+------+---------+--------+-----+---------+------+------------+------+--------+------+-------|
...
| INHERITANCE                   | Clojure | Erlang | F# | Haskell | Java | JavaScript | Perl | Python | Ruby | Scala |
|-------------------------------+---------+--------+----+---------+------+------------+------+--------+------+-------|
...
| FUNCTIONS                         | bash | Clojure | Erlang | F# | Haskell | Java | JavaScript | Perl | Python | Ruby | Scala |
|-----------------------------------+------+---------+--------+----+---------+------+------------+------+--------+------+-------|
| function type parameters          | no   |         |        |    |         | yes  |            |      | no     |      | yes   |
...
| BINDINGS & SCOPE               | bash | Clojure | Erlang | F#  | Haskell | Java | JavaScript | Perl | Python | Ruby | Scala |
|--------------------------------+------+---------+--------+-----+---------+------+------------+------+--------+------+-------|
...
| CONTROL                                         | bash | Clojure | Erlang | F# | Haskell | Java | JavaScript | Perl | Python | Ruby | Scala |
|-------------------------------------------------+------+---------+--------+----+---------+------+------------+------+--------+------+-------|
...
| LIBRARY                 | bash | Clojure | Erlang | F# | Haskell | Java | JavaScript | Perl | Python | Ruby | Scala |
|-------------------------+------+---------+--------+----+---------+------+------------+------+--------+------+-------|
...
| EVALUATION                    | bash | Clojure | Erlang | F# | Haskell | Java | JavaScript | Perl | Python | Ruby | Scala |
|-------------------------------+------+---------+--------+----+---------+------+------------+------+--------+------+-------|
| ?lazy functions?              |      |         |        |    |         |      |            |      |        |      |       |
| ?lazy expressions?            |      |         |        |    |         |      |            |      |        |      |       |
...
| PROGRAM TEXT        | Clojure | Erlang | F# | Haskell | Java | JavaScript | Perl | Python | Ruby | Scala |
|---------------------+---------+--------+----+---------+------+------------+------+--------+------+-------|
...
| COLLECTIONS SYNTAX | bash | Clojure | Erlang | F#  | Haskell | Java | JavaScript | Perl | Python | Ruby | Scala |
|--------------------+------+---------+--------+-----+---------+------+------------+------+--------+------+-------|
...
| SPECIAL SYNTAX      | bash | Clojure | Erlang | F# | Haskell | Java | JavaScript | Perl | Python | Ruby | Scala |
|---------------------+------+---------+--------+----+---------+------+------------+------+--------+------+-------|
| regular expressions |      | no      | no     | no | no      | no   | no         | yes  | no     | yes  | no    |
| system calls        |      | no      | no     | no | no      | no   | no         | yes  | no     | yes  | no    |


| BASIC TYPES                 | bash | Clojure | Erlang | F# | Haskell | Java | JavaScript | Perl | Python | Ruby | Scala |
|-----------------------------+------+---------+--------+----+---------+------+------------+------+--------+------+-------|
...
| IMPLEMENTATION              | bash | Clojure | Erlang | F#  | Haskell | Java | JavaScript | Perl | Python | Ruby | Scala |
|-----------------------------+------+---------+--------+-----+---------+------+------------+------+--------+------+-------|
| concurrency                 |      |         |        |     |         |      |            |      |        |      |       |
